...
export const AdditionalProductsItem = ({cards}) => {
    ...
    return (
        <>
        <div className="products-wrap others-products-wrap">
            {cards?.map(card =>
                    ...
                    <div className="products-item-preview">
                        ...
                        {(cartList?.find(cardCart => cardCart.id === card.id))
                            ...
                            <button onClick={(event) => stopEffect(event)} className="products-item-btn-done products-item-btn">
                                ...
                                <svg onClick={(event) => handleRemoveCardFromCart(event, card.id)} className="product-selected-btn-done-cross" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
