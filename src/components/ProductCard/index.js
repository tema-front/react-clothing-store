                    ...
                    <div className="products-item-preview">
                        ...
                        {(cartList.find(card => card.id === item.id))
                            ...
                            <button onClick={(event) => stopEffect(event)} className="products-item-btn-done products-item-btn">
                                ...
                                <svg onClick={(event) => handleRemoveCardFromCart(event, item.id)} className="product-selected-btn-done-cross" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                            ...
                            :
                            <button className="products-item-btn" onClick={(event) => handleAddProductToCart(event, item)}>
