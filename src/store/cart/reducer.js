import { ADD_CARD_TO_CART, CHANGE_COLOR, CHANGE_SIZE, DECREASE_QUANTITY, EMPTY_CART, INCREASE_QUANTITY, RECIEVE_DELIVERY_PRICE, REMOVE_CARD_FROM_CART, RESET_DELIVERY_PRICE } from "./actions";
