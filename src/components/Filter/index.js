    ...
    return (
        ...
        {visibilityFilter &&
            <div className="catalog-filter">
                ...
                <svg onClick={onVisibilityFilter} className="products-added-item-cross cross-catalog-filter" width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
