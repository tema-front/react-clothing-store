...
export const SliderSelectedProduct = ({ cardId }) => {
    ...
    <section class="product-selected-slider">
        <button class="slide-btn slide-btn-left">
        ...
        <div class="product-selected-wrp">
            <img class="product-selected-img" src={`https://picsum.photos/id/${cardId + 8}/600/724`} height='724' alt="Product photo" />
        </div>
        <button class="slide-btn slide-btn-right">
            <svg width="31" height="31" viewBox="0 0 31 31" xmlns="http://www.w3.org/2000/svg">
