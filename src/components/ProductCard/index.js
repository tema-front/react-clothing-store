            ...
            {cards?.map(item => (
                <div className="products-item" key={item.id}>
                    <div className="products-item-preview">
                        ...
                        {/* <img className="products-item-img" src={`https://picsum.photos/360/420?random=${item.id}`} alt="products-item" height="420" /> */}
                        {/* <img className="products-item-img" src={item.id} alt="products-item" height="420" /> */}
                        
                        <button className="products-item-btn" onClick={() => handleAddProductToCart(item)}>
